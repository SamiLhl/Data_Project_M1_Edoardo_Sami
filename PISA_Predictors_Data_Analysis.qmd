...
world_map <- joinCountryData2Map(Dataset, joinCode = "ISO3", nameJoinColumn = "Country")

# Create the map
mapDevice()

# Plot the map with color-coded values
mapCountryData(
  world_map,
  nameColumnToPlot = "Variable",
  catMethod = "fixedWidth",
  mapTitle = "World Map with Color-Coded Variable",
  colourPalette = "Blues"
)
