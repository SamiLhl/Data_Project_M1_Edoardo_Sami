...
For simplicity however, we only realize a linear model of Entrance Age and PISA scores.
...
#initial_val <- list(a=100, b=2)
#Density_Model <- nls(Science_Score ~ a + Entr_M ^ b, data=Entrance_PISA, start = initial_val)
#Density_Model <- polr(Entr_M ~ Science_Score, data=Entrance_PISA)
