...
```{r}
Policy_matrix <- Dataset |> select(Average_Score, Entrance_Mandatory, Mean_Yrs_Schooling, Survival_Rate_Primary, Gov_Expenditure, Enrolment_Rate, Share_Private) |> correlate()
knitr::kable(Policy_matrix)
```
...
Barshay, J. (2023), Proof points there is a worldwide problem in math and it’s not just about the pandemic. The Hechinger Report. \https://hechingerreport.org/proof-points-there-is-a-worldwide-problem-in-math-and-its-not-just-about-the-pandemic/
