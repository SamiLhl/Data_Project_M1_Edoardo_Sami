...
ylab("Math Score") +
ggtitle("Scatterplot of PISA Math Score given gvernament expenditure") +
theme_minimal()+
theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
Math score is independet from the governament expenditure. The average governament expenditure is around 1 and is related to a math score of 490.
By increasing the expendirture there is no benefit to the math score. 
