...
Household income 
```{r}
#Household_income<- vroom(here("HI_Data/HH_DASH_22112023163138566.csv"))
```
...
```{r}
Pisa_score_Mathscale <- Pisa_score_Mathscale |> rename("Math_Score"="Average(all_students)") |> fill(`Year/Study`)
Pisa_score_Mathscale_gender <- Pisa_score_Mathscale_gender |> rename("Math_Score_F" = `Average(Female)`, "Math_Score_M" = `Average(Male)`) |> fill(`Year/Study`)
Pisa_score_readingscale <- Pisa_score_readingscale |> rename("Reading_Score"="Average(all_students)") |> fill(`Year/Study`)
Pisa_score_readingscale_gender <- Pisa_score_readingscale_gender |> rename("Reading_Score_F" = `Average(Female)`,"Reading_Score_M" = `Average(Male)`) |> fill(`Year/Study`)
Pisa_score_Sciencescale <- Pisa_score_Sciencescale |> rename("Science_Score"="Average(all_students)") |> fill(`Year/Study`)
Pisa_score_Sciencescale_gender <- Pisa_score_Sciencescale_gender |> rename("Science_Score_F" = `Average(Female)`, "Science_Score_M" = `Average(Male)`) |> fill(`Year/Study`)
